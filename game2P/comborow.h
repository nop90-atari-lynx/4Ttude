...
typedef	struct COMBOROW_S {
	...
	// unfilled.
	unsigned char m_spots[NUM_ON_SIDE];	// The 4 values in the row
} COMBOROW, *LPCOMBOROW;

// Operations on comborows:
//
// Initialize a row
void	cr2_init(LPCOMBOROW cr, signed char one, signed char two, signed char three, signed char four);
