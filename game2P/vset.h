...
extern	void	vs_incscore(LPVSET, signed char);
extern	void	vs_decscore(LPVSET, signed char);
extern	bool	vs_isable(LPVSET, signed char);
extern	void	vs_addscore(LPVSET, signed char, int);
extern	void	vs_subscore(LPVSET, signed char, int);
extern	void	vs_disable(LPVSET, signed char);
extern	signed char	vs_pickmember(LPVSET);
