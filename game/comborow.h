...
//
// Initialize a row
void	cr_init(LPCOMBOROW cr, signed char one, signed char two, signed char three, signed char four);
...
bool	cr_register(LPCOMBOROW cr, GB_PIECE who, signed char where);
// Answer the question of, can someone move to the where location?  That is,
// is "where" still able to accept pieces?
bool	cr_isable(LPCOMBOROW cr, signed char where);
